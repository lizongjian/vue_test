  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" label="序号" width="95">
          <!-- Scoped slot 可以获取到表格里面的 row, column, $index 和 store（table 内部的状态管理）的数据-->  
        <template slot-scope="scope"> <!--//--- 这里取到当前单元格-->
          {{ scope.$index }} <!--//--- 这里取到当前单元格索引-->
        </template>
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      ...
      this.list = [{'beanName':'名称','methodName':'方法名'},{'beanName':'名称','methodName':'方法名'},{'beanName':'名称','methodName':'方法名'},{'beanName':'名称','methodName':'方法名'},{'beanName':'名称','methodName':'方法名'},{'beanName':'名称','methodName':'方法名'},{'beanName':'名称','methodName':'方法名'},{'beanName':'名称','methodName':'方法名'},{'beanName':'名称','methodName':'方法名'},{'beanName':'名称','methodName':'方法名'},{'beanName':'名称','methodName':'方法名'},{'beanName':'名称','methodName':'方法名'}]
      this.totalSize = 11
    ...
    addOrUpdateHandle(item) {
      ...
      this.$nextTick(() => {
        //ref="addOrUpdate" 绑定再元素上 直接可以通过这种方式获取
